...
struct FeedbackView: View {
    ...
    var body: some View {
                ...
                VStack(alignment: .leading, spacing: 8) {
                    HStack {
                        ...
                        VStack(alignment: .leading) {
                            ...
                            Text("Help us improve SpeachText1.0")
                                .font(.system(size: 16))
                    ...
                    VStack(alignment: .leading, spacing: 12) {
                        HStack(spacing: 12) {
                            ...
                            VStack(alignment: .leading, spacing: 4) {
                                ...
                                Text("Your feedback helps us make SpeachText1.0 even better")
                                    .font(.system(size: 14))
        ...
        .alert("Feedback Sent", isPresented: self.$showFeedbackConfirmation) {
            ...
            Text("Thank you for helping us improve SpeachText1.0.")
        }
